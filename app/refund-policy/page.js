        ...
        <div>
            <Layout headerStyle={1}   >
                ...
                <div className='container'>
                    ...
                    <p className='wow fadeInUp' style={{ paddingLeft: '47px', paddingRight: '47px', paddingBottom: '47px' }} > To be eligible for a refund, you must submit a refund request within 7 days of the program start date. Requests submitted after this period will not be considered.
                    </p>


                    <h6 className='wow fadeInUp' style={{ paddingLeft: '47px', paddingRight: '47px', paddingTop: '0px', paddingBottom: '10px' }}>Submit a Refund Request::</h6>
                    <p className='wow fadeInUp' style={{ paddingLeft: '47px', paddingRight: '47px', paddingBottom: '47px' }} >To initiate a refund, please contact our customer support team within the 7-day window.
                    </p>
                    ...
                    <h6 className='wow fadeInUp' style={{display:'flex',justifyContent:'center', paddingLeft: '47px', paddingRight: '47px', paddingTop: '15px', paddingBottom: '10px' }}>
