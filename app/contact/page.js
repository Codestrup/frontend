...
const formValidationSchema = Yup.object().shape({
  ...
  internship: Yup.string().notRequired(),
  ...
  const handleFormSubmit = async (values, actions) => {
    try {
      const response = await axios({
        method: "POST",
        url: "https://api.codestrup.in/contactUs",
        data: {
          name: values.name,
          email: values.email,
                ...
                <div className="row g-4 ">
                  <div className="col-lg-6">
                    <div className="contact-left-items">
                      <div className="contact-info-area-2">
                        ...
                        <iframe
                          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d70075.80581196204!2d73.77501680579999!3d18.455047562079383!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2952db1cef7af%3A0x8cf0f07a4dfb420b!2sCodestrup%20Infotech%20Private%20Limited!5e0!3m2!1sen!2sin!4v1725277656889!5m2!1sen!2sin"
                          width="100%"
                          height="200"
                          style={{ border: 0 }}
                          allowFullScreen
                  ...
                  <div className="col-lg-6">
                    <div className="contact-content">
                      <h2>
                        Send Your Query –<span>We're Here to Assist You</span>{" "}
                      </h2>
                          ...
                          <Form className="contact-form-items">
                            <div className="row g-4">
                              ...
                              >
                                ...
                                >
                                  <span>Interested Internship</span>
