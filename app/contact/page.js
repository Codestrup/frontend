                                ...
                                <div className="row g-4 ">
                                            ...
                                            <div className="contact-info-area-2">
                                                <div className="contact-info-items mb-4">
                                                    ...
                                                    <div className="content">
                                                        <p style={{ fontSize: '20px', fontWeight: '500' }}>Call Us 7/24</p>
                                                        <p >
                                                            <Link href="tel:+9699997689" style={{ color: "white" }}>
                                                                +91 9699997689
                                                            </Link>
                                                        </p>
                                                    </div>
                                                ...
                                                <div className="contact-info-items mb-4">
                                                    ...
                                                    <div className="content">
                                                        <p style={{ fontSize: '20px', fontWeight: '500' }}>Make a Quote</p>
                                                        <p>
                                                            <Link href="mailto:info@codestrup.com" style={{ color: 'white' }}>info@codestrup.com
                                                            </Link>
                                                        </p>
                                                    </div>
                                                </div>
                                                <div className="contact-info-items border-none">
                                                    ...
                                                    <div className="content"  >
                                                        ...
                                                        <p>
                                                            Office No.301 3rd Floor , Umed Building , Nanded City Rd , Pune , Maharastra 411041
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div className="col-lg-6">
                                        <div className="contact-content">
                                            <h2>Send Your Query –<span>We're Here to Assist You</span> </h2>
