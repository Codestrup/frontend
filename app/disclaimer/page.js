        ...
        <div>
            <Layout headerStyle={1} footerStyle={1}   >
                <div style={{ paddingBottom: '30px' }}>
                    <h2 className="text-center wow fadeInUp terms-text" style={{ backgroundColor: '#384bff ', color: 'white' }} data-wow-delay=".3s">Disclaimer</h2>
                </div>
                <div className='container'>
                    ...
                    <p className='wow fadeInUp' style={{ padding: '47px' }} >The Company ensures steady commitment to your usage of the Platform and privacy with regard to the protection of your invaluable information. This document contains information about the Website and mobile application https://codestrup.in/ hereinafter referred to as the “Platform”.
                        ...
                        The firm will not be responsible for any damage suffered by vendors from use or purchase of the products or services on this platform. This includes but is not limited to, loss of revenue/data resulting from delays, non-deliveries, missed deliveries, or service interruptions as may occur because of any act/omission of parties. This disclaimer of liability also applies to any damages or injury caused by any failure of performance, error, omission, interruption, deletion, defect, delay in operation or transmission, computer virus, communication line failure, theft or destruction or unauthorized access to, alteration of, or use of record, whether for breach of contract, tortuous behaviour, negligence, or under any other cause of action.

                        The firm also makes it clear that it shall not be held liable for any damage/hurt/inconvenience caused to the vendor through the course of the provision of services or as a result of the vendors’ actions. The firm makes no representations or warranties as to the conduct of the vendors. The firm takes no responsibility for any content that vendors send or receive from other vendors or third-party posts through the website or platform. Any material downloaded or otherwise obtained through use of the service is accessed at the vendors own discretion and risk.
                        ...
                        The services on the platform are based on the information that is given by the user and the correctness of authenticity of the same is assured by the users, the users cannot hold the platform accountable for the mistakes caused by any error in the information any and or all the intellectual property on the firm platform may have been trademarked or copyrighted by the firm and or any other such person and any use, misuse or manipulations that may be in relation to the intellectual property shall be the responsibility of the vendor. However, when brought to the notice of the firm, there shall be immediate legal action taken.

                        The firm bears no responsibility whatsoever for any consequences arising from the use of the said services by vendors. The use of the services in the platform is the sole responsibility of the vendor(or legally authorised person on behalf of the vendor), and in case of any negligence on the part of the vendor in acting on the same shall not be construed as imposing any liability, direct or indirect, on the firm/platform.
