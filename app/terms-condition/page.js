        ...
        <div>
            <Layout headerStyle={1}   >
                <div style={{ paddingBottom: '30px' }}>
                    <h2 className="text-center wow fadeInUp terms-text" style={{ backgroundColor: '#384bff ', color: 'white' }} data-wow-delay=".3s">Terms & Condition</h2>
                </div>
                <div className='container'>
                    ...
                    <h6 className='wow fadeInUp' style={{ paddingLeft: '47px', paddingRight: '47px', paddingTop: '0px', paddingBottom: '10px' }}>DEFINITION</h6>
                    <p className='wow fadeInUp' style={{ paddingLeft: '47px', paddingRight: '47px', paddingBottom: '47px' }} >For the purpose of these Terms of Use (“Terms”), wherever the context so requires,
                        "We", "Our", and "Us" shall mean and refer to the Platform and/or the Company, as the context so requires.
                        "User" shall mean and refer to natural and legal individuals who use the Website and Mobile Application and who is of sound mind and competent to make sound and informed decisions.
                        "Services" shall refer to tool selection, compliance, monitoring, DevOps automation, assessment & management.
                        "Third Parties" refer to any Application, Company or individual apart from the User and the creator of this Website and Mobile Application and Mobile Application.
                        The term "Platform" refers to the Website and Mobile Application which provides the user with the facility to seek information through Service guides published by the Company.
                    </p>


                    <h6 className='wow fadeInUp' style={{ paddingLeft: '47px', paddingRight: '47px', paddingTop: '0px', paddingBottom: '10px' }}>GENERAL TERMS</h6>
                    <p className='wow fadeInUp' style={{ paddingLeft: '47px', paddingRight: '47px', paddingBottom: '47px' }} >The headings of each section in these Terms are only for the purpose of organizing the various provisions under these Terms in an orderly manner and shall not be used by either Party to interpret the provisions contained herein in any manner. Further, it is specifically agreed to by the Parties that the headings shall have no legal or contractual value.
                    ...
                    <h6 className='wow fadeInUp' style={{ paddingLeft: '47px', paddingRight: '47px', paddingTop: '0px', paddingBottom: '10px' }}>SERVICE OVERVIEW
                    </h6>
                    <p className='wow fadeInUp' style={{ paddingLeft: '47px', paddingRight: '47px', paddingBottom: '47px' }} >

                        The platform provides services related to tool selection, compliance, monitoring, DevOps automation, assessment & management.
                    </p>

                    <h6 className='wow fadeInUp' style={{ paddingLeft: '47px', paddingRight: '47px', paddingTop: '0px', paddingBottom: '10px' }}>REGISTRATION
                    </h6>
                    <p className='wow fadeInUp' style={{ paddingLeft: '47px', paddingRight: '47px', paddingBottom: '47px' }} >
                        <p>
                        ...
                        Linking of Gmail and Facebook accounts are not mandatory. However, Users may register by linking either of the following social media accounts, Facebook, Google Plus. All registrations on the platform are free of cost and no User shall be charged for any such registration the platform.

                    </p>


                    <h6 className='wow fadeInUp' style={{ paddingLeft: '47px', paddingRight: '47px', paddingTop: '0px', paddingBottom: '10px' }}>ELIGIBILITY
                    </h6>
                    <p className='wow fadeInUp' style={{ paddingLeft: '47px', paddingRight: '47px', paddingBottom: '47px' }} >
                        ...
                        In the event of a minor accessing the Website and Mobile Application, it would be the responsibility of his immediate guardian to monitor the minor’s use, the platform or the Company will not be liable for any consequences. If we discover that you have created an account that violates these rules, we will terminate your account.
                    </p>


                    <h6 className='wow fadeInUp' style={{ paddingLeft: '47px', paddingRight: '47px', paddingTop: '0px', paddingBottom: '10px' }}>CONTENT
                    </h6>
                    <p className='wow fadeInUp' style={{ paddingLeft: '47px', paddingRight: '47px', paddingBottom: '47px' }} >
                    ...
                    <h6 className='wow fadeInUp' style={{ paddingLeft: '47px', paddingRight: '47px', paddingTop: '0px', paddingBottom: '10px' }}>INDEMNITY
                    </h6>
                    <p className='wow fadeInUp' style={{ paddingLeft: '47px', paddingRight: '47px', paddingBottom: '47px' }} >
                        ...
                        Further you shall indemnify the Company, its subsidiaries, its affiliates and licensors against any loss, expense, cost or damage incurred by any or all of them as a result of your breach of these Terms or your unauthorized use of the Content or the Platform.
                    </p>

                    <h6 className='wow fadeInUp' style={{ paddingLeft: '47px', paddingRight: '47px', paddingTop: '0px', paddingBottom: '10px' }}>TERM & TERMINATION
                    </h6>
                    <p className='wow fadeInUp' style={{ paddingLeft: '47px', paddingRight: '47px', paddingBottom: '47px' }} >
                    ...
                    <h6 className='wow fadeInUp' style={{ paddingLeft: '47px', paddingRight: '47px', paddingTop: '0px', paddingBottom: '10px' }}>COMMUNICATION
                    </h6>
                    <p className='wow fadeInUp' style={{ paddingLeft: '47px', paddingRight: '47px', paddingBottom: '47px' }} >
                    ...
                    <h6 className='wow fadeInUp' style={{ paddingLeft: '47px', paddingRight: '47px', paddingTop: '0px', paddingBottom: '10px' }}>INTELLECTUAL PROPERTY RIGHTS
                    </h6>
                    <p className='wow fadeInUp' style={{ paddingLeft: '47px', paddingRight: '47px', paddingBottom: '47px' }} >
                    ...
                    <h6 className='wow fadeInUp' style={{ paddingLeft: '47px', paddingRight: '47px', paddingTop: '0px', paddingBottom: '10px' }}>FORCE MAJEURE
                    </h6>
                    <p className='wow fadeInUp' style={{ paddingLeft: '47px', paddingRight: '47px', paddingBottom: '47px' }} >
                    ...
                    <h6 className='wow fadeInUp' style={{ paddingLeft: '47px', paddingRight: '47px', paddingTop: '0px', paddingBottom: '10px' }}>DISPUTE RESOLUTION AND JURISDICTION
                    </h6>
                    <p className='wow fadeInUp' style={{ paddingLeft: '47px', paddingRight: '47px', paddingBottom: '47px' }} >
                        It is expressly agreed to by the Parties hereto that the formation, interpretation, and performance of these Terms and any disputes arising therefrom will be resolved through a two-step Alternate Dispute Resolution (“ADR”) mechanism. It is further agreed to by the Parties that the contents of this Section shall survive even after the termination or expiry of the Terms and/or Policy.
                        <p style={{ paddingTop: '10px' }}>
                            <span style={{ color: '#384bff' }}>Mediation: </span>In case of any dispute between the parties, the Parties will attempt to resolve the same amicably amongst themselves, to the mutual satisfaction of all parties. In the event that the Parties are unable to reach such an amicable solution within thirty (30) days of one Party communicating the existence of a dispute to any other Party, the dispute will be resolved by arbitration, as detailed herein below;
                            Arbitration: In the event that the Parties are unable to amicably resolve a dispute by mediation, said dispute will be referred to arbitration by a sole arbitrator to be appointed by the Company, and the award passed by such sole arbitrator will be valid and binding on all parties. The Parties shall bear their own costs for the proceedings, although the sole arbitrator may, in his/her sole discretion, direct either Party to bear the entire cost of the proceedings. The arbitration shall be conducted in English, and the seat of Arbitration shall be the city of Madhya Pradesh.
                    ...
                    <p className='wow fadeInUp' style={{ paddingLeft: '47px', paddingRight: '47px', paddingBottom: '47px' }} >
                        ...
                        <p>
                            <span style={{ color: '#384bff' }}>Entire Agreement:</span>
                        ...
                        <p>
                            <span style={{ color: '#384bff' }}>Waiver: </span>
                        ...
                        <p>
                            <span style={{ color: '#384bff' }}>Severability: </span>
