                        ...
                        <Box mt={2}>
                            ...
                            <ol>
                                {internshipPerks.map((item) => (
                                    <div className="d-flex justify-content-start " style={{gap:'6px'}}>
                        ...
                        <Box>
                            <ul>
                                <li style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                                    ...
                                    <Link href="http://codestrup.in.s3-website.ap-south-1.amazonaws.com/"
                                        style={{
                                            color: "#384bff",
                                ...
                                {socialLinks.map((item) => (
                                    <li
                                        key={item.id}
                                        style={{ display: "flex", alignItems: "center", gap: "20px", justifyContent: 'start',width:'100%' }}
                                    >
                                        <p>{item.name}</p>
                                      -
                                        <Link href={item.link}
